...
{
    public partial class FrmSharedResourse : Form
    {
        public FrmSharedResourse()
        {
            InitializeComponent();
        ...
        private void FrmSharedResourse_Load(object sender, EventArgs e)
        {
        }
        ...
        private void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select both year and module.");
                return;
            }
